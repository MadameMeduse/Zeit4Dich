          ...
          ease: [0.22, 1, 0.36, 1]
            ...
            <div className="order-2 space-y-6 sm:space-y-8">
              ...
              <div className="space-y-4 text-[#6B6560] text-base sm:text-lg leading-relaxed font-['Montserrat'] font-light">
                ...
                <p className="font-normal">Ich begleite Menschen seit über 23 Jahren mit Atem, Berührung und Präsenz. Meine Arbeit ist geprägt von Tiefe, Intuition und einem Ur-Vertrauen in das, was im Menschen selbst angelegt ist: die Kraft zur Wandlung, zur Entlastung – zur inneren Rückkehr nach Hause.<br /><br />Dank meiner Ausbildungen an drei verschiedenen Atemschulen in den USA, England und Schweden verbinde ich unterschiedliche Atemtechniken mit weiteren sanften Formen der Unterstützung. So entsteht ein Raum, der sich ganz an dem orientiert, was du gerade brauchst – ob im Einzelsetting, in Gruppen oder im warmen Wasser. </p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <motion.div {...fadeInUp} className="max-w-6xl mx-auto">
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 sm:p-12 lg:p-16 shadow-xl">
            <h2 className="font-['Playfair_Display'] text-3xl sm:text-4xl lg:text-5xl text-[#4A4440] font-light mb-8 lg:mb-12" style={{
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              <div className="space-y-5 text-[#6B6560] text-base sm:text-lg leading-relaxed font-['Montserrat']">
                <p>
                  Meine Arbeit ist geprägt von Tiefe, Intuition und einem Ur-Vertrauen in das, was im
                  Menschen selbst angelegt ist: die Kraft zur Wandlung, zur Entlastung – zur inneren
                  Rückkehr nach Hause.
                </p>
                <p>Nach meinen Ausbildungen an drei verschiedenen Atemschulen in den USA, England und Schweden habe ich unterschiedliche Atemtechniken mit weiteren sanften Formen der Unterstützung verbunden und eine neue Atemmethode namens der UR-ATEM© entwickelt, in der ich Atemarbeit mit Körperarbeit kombiniere.</p>
              </div>
              <div className="space-y-5 text-[#6B6560] text-base sm:text-lg leading-relaxed font-['Montserrat']">
                <p>
                  So entsteht ein Raum, der sich ganz an dem orientiert, was du gerade brauchst – ob im
                  Einzelsetting, in Gruppen oder im warmen Wasser.
                </p>
                <p>
                  Ich bin ein ruhiger, offener Mensch. Ich arbeite intuitiv, mit einem feinen Gespür für
                  Blockaden – und für Wege, sie zu lösen.
                </p>
                <p className="italic text-[#8B7F77]" style={{
                color: "#4d83a4"
              }}>
                  Freude ist mir wichtig. Stille auch. Und echte Begegnung.
                </p>
              </div>
            </div>
          </div>
          ...
          backgroundPosition: "center"
            ...
            <div className="relative z-10">
              ...
              <p className="text-[#6B6560] text-base sm:text-lg leading-relaxed ml-12 font-['Montserrat']">
                Ein Schlüssel zu inneren Räumen, zu Gefühlen, zu Erinnerungen – und zu dem, was sich lösen möchte, aber noch nicht konnte. Er wird zur unsichtbaren Brücke zwischen Körper und Seele.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          once: true
            ...
            <motion.div variants={fadeInUp} className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              justifyContent: "center"
                ...
                <span style={{
                fontStyle: 'italic'
              }}>Rebirthing</span> Breathwork – Intensive Atemarbeit zur emotionalen Befreiung und energetischen Klärung.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              justifyContent: "center"
                ...
                Transformational Breath® – Eine kraftvolle Methode, die Atem, Bewusstsein und Selbstheilung verbindet.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              justifyContent: "center"
                ...
                Atemarbeit im warmen Wasser (WATA) – Eine zutiefst nährende Form der Atembegleitung.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              <img src="https://storage.googleapis.com/storage.magicpath.ai/user/351284685155995648/assets/efb02a14-6f1c-41c7-b0a3-d70faa108936.png" alt="Pferde in nordischer Natur" className="rounded-3xl shadow-2xl w-full aspect-[4/3] object-cover" style={{
              objectFit: "cover",
