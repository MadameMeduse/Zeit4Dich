...
export const MassagePreviewSection: React.FC<MassagePreviewSectionProps> = ({
  ...
  return <section id="massage-preview" className="py-20 sm:py-28 lg:py-36 px-4 sm:px-6 lg:px-8 bg-[#C9C4BA]">
      <div className="max-w-7xl mx-auto">
        ...
        once: true
          ...
          {/* Desktop: Image on right with offset, Mobile: Image stacked on top */}
          <div className="flex flex-col lg:flex-row-reverse lg:items-start lg:gap-12 xl:gap-16 space-y-6 lg:space-y-0">
            {/* Image */}
            <figure className="lg:flex-shrink-0 lg:w-1/2 xl:w-5/12 lg:translate-y-8">
            ...
            {/* Text Content */}
            <div className="flex flex-col space-y-6 lg:flex-1 items-center md:items-start">
